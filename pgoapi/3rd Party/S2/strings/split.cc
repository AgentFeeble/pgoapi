...
#include "split.h"
#include "strutil.h"
#include "hash_jenkins_lookup2.h"
...
DEFINE_SPLIT_ONE_NUMBER_TOKEN(Int, int, (int)strto32_0)
DEFINE_SPLIT_ONE_NUMBER_TOKEN(Int32, int32, (int32)strto32_0)
DEFINE_SPLIT_ONE_NUMBER_TOKEN(Uint32, uint32, (uint32)strtou32_0)
...
#endif
DEFINE_SPLIT_ONE_NUMBER_TOKEN(DecimalInt, int, (int)strto32_10)
DEFINE_SPLIT_ONE_NUMBER_TOKEN(DecimalInt32, int32, (int32)strto32_10)
DEFINE_SPLIT_ONE_NUMBER_TOKEN(DecimalUint32, uint32, (uint32)strtou32_10)
